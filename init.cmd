...
if "%ERRORLEVEL%"=="0" (
	...
	echo "Launched Second Window" :: KILLL
) ELSE (
	start %StartExe% /LoadCfgFile "%ConfigDir%\ConEmu.xml" /FontDir "%FontDir%" /Icon "%BaseDir%\icons\omega_256.ico" /run "@%ConfigDir%\powershell.cmd"
)